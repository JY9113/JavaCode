...
public class ContactMain04 {
	...
	private static void deleteByIndex() {
		...
		scanner.nextLine();
		int result;
		if((indexNum -1) < list.size()){
			System.out.println("                           선택하신 정보는 [" + list.get((indexNum-1)).getName() + "] 의 정보입니다.");
			System.out.println();	
			System.out.println("                           -------------------");
			System.out.println("                           |  0. 종료        1. 삭제    |");
			System.out.println("                           -------------------");	
			System.out.print("                           선택 > ");	
			...
			case 0 :
				...
				break;
			case 1 :
				System.out.print("                           정보를 삭제합니다");				
				
				break;     
			}
			
			result = dao.delete((indexNum-1));
			...
			System.out.println("                           현재 등록된 연락처의 인덱스 번호는 1부터 " + (list.size()) + " 까지 입니다.");
